...
- [[topical-authority-in-ai-search]] — the mention-share-drives-selection
  link at the topic level: 74% of users pick the top-*mentioned* brand,
  yet mention share and citation share are near-decoupled (-0.229).
